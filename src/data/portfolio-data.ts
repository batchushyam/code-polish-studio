...
export const PROJECTS: Project[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: "bullets", items: [
            ...
            "The touchscreen on our device was nice, but the hospital staff valued the device's battery life a lot more and the touchscreen drained energy."
          ]}
      ...
      },
      {
        title: "Post-Travel",
        content: [
          { type: "paragraph", text: " As of February 2026, I am currently working on creating a ring that works on drip chambers of different sizes using a spring loaded system, re-doing the housing with buttons instead of a touchscreen, and creating a peristaltic motor to control the flow rate of infusion pumps. This section will be updated as progress is made." },          
        ]
      }
    ]
  },
