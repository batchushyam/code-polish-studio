        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left order-2 md:order-1">
            ...
            <motion.p
              ...
              className="font-mono text-sm tracking-widest uppercase text-accent mb-4"
            >
              About Me
            </motion.p>
            ...
            <motion.h1
              ...
              className="font-serif text-4xl sm:text-5xl lg:text-6xl text-foreground mb-6 leading-[1.1] tracking-tight"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-muted-foreground font-light leading-relaxed mb-8"
            >
